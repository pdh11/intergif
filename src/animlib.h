...
anim Anim_FromData( const void *data, unsigned int size,
                    palettemapper pmap, BOOL bSame, BOOL bDiffuse,
                    BOOL bZigZag, BOOL bGrey );
anim Anim_FromFile( const char *filename, palettemapper pmap, BOOL bSame,
                    BOOL bDiffuse, BOOL bZigZag, BOOL bGrey );
anim Anim_FromFiles( const char *firstname, palettemapper pmap, BOOL bSame,
                     BOOL bDiffuse, BOOL bZigZag, BOOL bGrey );
anim Anim_FromList( const char *listfile, palettemapper pmap, BOOL bSame,
                     BOOL bDiffuse, BOOL bZigZag, BOOL bGrey );
